...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:15.5-alpine3.19 docker.io/jhumanj/opnform-client:latest docker.io/jhumanj/opnform-api:latest docker.io/redis:7" \
    "${container}"
# Commit the image
